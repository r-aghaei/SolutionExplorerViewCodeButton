...
namespace VSIXProject1
{
    ...
    internal sealed class Command1
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("38cd48d4-15df-4405-bce3-f08d2ef03344");
       ...
       private void Execute(object sender, EventArgs e)
       {
           ...
           VsShellUtilities.OpenDocumentWithSpecificEditor(package,
               dte.SelectedItems.Item(1)?.ProjectItem.FileNames[1],
               Microsoft.VisualStudio.VSConstants.VsEditorFactoryGuid.TextEditor_guid,
